# Awesome Löve [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 435,646 | 🐛 67 | 📅 2026-01-28 with stars
...
* [g3d](https://github.com/groverburger/g3d) ⭐ 750 | 🐛 2 | 🌐 Lua | 📅 2025-12-16 - Simple and easy 3D engine for LÖVE.
* [3DreamEngine](https://github.com/3dreamengine/3DreamEngine) ⭐ 463 | 🐛 14 | 🌐 Lua | 📅 2023-05-25 - An awesome 3D engine for LÖVE.
* [Menori](https://github.com/rozenmad/Menori) ⭐ 265 | 🐛 6 | 🌐 Lua | 📅 2025-08-26 - Library for 3D rendering with LÖVE.
...
* [IQM](https://github.com/excessive/iqm-exm) ⭐ 40 | 🐛 7 | 🌐 Python | 📅 2021-06-04 - Inter-Quake Model loader (binary).
* [anim9](https://github.com/excessive/anim9) ⭐ 30 | 🐛 0 | 🌐 Lua | 📅 2020-05-07 - 3D skeletal animation library (design to be used with IQM and IQE).
...
* [Jumper](https://github.com/Yonaba/Jumper) ⭐ 644 | 🐛 38 | 🌐 Lua | 📅 2022-10-21 - Grid-based pathfinding library.
* [Lua-star](https://github.com/wesleywerner/lua-star) ⭐ 78 | 🐛 0 | 🌐 Lua | 📅 2021-07-25 - Easy and pure Lua A\* path finding.
...
* [beehive.lua](https://github.com/drhayes/beehive.lua) ⭐ 25 | 🐛 0 | 🌐 Lua | 📅 2022-06-09 - A functional behavior tree implementation.
...
* [anim8](https://github.com/kikito/anim8) ⭐ 941 | 🐛 7 | 🌐 Lua | 📅 2022-01-20 - Animation library.
* [SYSL-Text](https://github.com/sysl-dev/SYSL-Text) ⭐ 114 | 🐛 0 | 🌐 Lua | 📅 2024-08-03 - Text animation and automatic wrapping library based on tags.
* [Peachy](https://github.com/josh-perry/peachy) ⭐ 110 | 🐛 1 | 🌐 Lua | 📅 2026-01-28 - A parser/renderer for Aseprite animations in LÖVE.
* [Aseprite loader](https://github.com/elloramir/love-ase) ⭐ 64 | 🐛 0 | 🌐 Lua | 📅 2023-07-14 - Complete ase/aseprite file loader (no json).
* [Walt](https://github.com/davisdude/Walt) ⭐ 63 | 🐛 0 | 🌐 Lua | 📅 2022-05-21 - Animation library.
...
* [parallax](https://github.com/idbrii/love-parallax) ⭐ 21 | 🐛 0 | 🌐 Lua | 📅 2022-01-11 - Scrolling library for any camera system; seamlessly tile background images.
...
* [lurker](https://github.com/rxi/lurker) ⭐ 362 | 🐛 7 | 🌐 Lua | 📅 2023-07-22 - Auto-swaps changed Lua files in a running game.
* [LÖVE API](https://github.com/love2d-community/love-api) ⭐ 352 | 🐛 14 | 🌐 Lua | 📅 2025-04-13 - The complete API documentation of LÖVE in a Lua table.
* [Lovebird](https://github.com/rxi/lovebird) ⭐ 328 | 🐛 6 | 🌐 Lua | 📅 2021-05-08 - Browser-based debug console.
* [LÖVE TypeScript Definitions](https://github.com/hazzard993/love-typescript-definitions) ⭐ 129 | 🐛 2 | 📅 2025-11-30 - Write LÖVE games with TypeScript.
* [LÖVE Build](https://github.com/nhartland/love-build) ⭐ 72 | 🐛 2 | 🌐 Shell | 📅 2026-01-09 - GitHub Action for automated cross-platform builds.
...
* [Push](https://github.com/Ulydev/push) ⭐ 616 | 🐛 14 | 🌐 Lua | 📅 2023-09-25 - A simple resolution-handling library for LÖVE.
* [Autobatch](https://github.com/rxi/autobatch) ⭐ 120 | 🐛 1 | 🌐 Lua | 📅 2018-09-10 - Small LÖVE module to automate the use of SpriteBatches.
* [turtle.lua](https://github.com/arthurealike/turtle.lua) ⭐ 103 | 🐛 0 | 🌐 Lua | 📅 2020-10-09 - Turtle graphics library for LÖVE.
* [deep](https://github.com/Nikaoto/deep) ⭐ 102 | 🐛 1 | 🌐 Lua | 📅 2025-02-09 - Adds Z axis; allows you to queue actions and draw calls.
* [Shöve](https://github.com/Oval-Tutu/shove) ⭐ 88 | 🐛 3 | 🌐 Lua | 📅 2025-05-23 - A powerful resolution-handler and rendering library for LÖVE.
* [Hot particles](https://github.com/ReFreezed/HotParticles) ⭐ 67 | 🐛 0 | 🌐 Lua | 📅 2022-03-20 - "Hot Particles is a particle editor for the LÖVE game framework."
...
* [SYSL-Pixel](https://github.com/sysl-dev/Sysl-Pixel) ⭐ 35 | 🐛 1 | 🌐 Lua | 📅 2020-06-10 - Pixel art focused scaler for graphics, position, screen-captures and shaders.
* [Runtime-TextureAtlas](https://github.com/EngineerSmith/Runtime-TextureAtlas) ⭐ 25 | 🐛 0 | 🌐 Lua | 📅 2025-11-13 - Texture atlas packer and renderer at runtime; no external tools.
...
* [center](https://github.com/swalrus1/center) ⭐ 17 | 🐛 0 | 🌐 Lua | 📅 2022-04-11 - A simple module to dynamically align and fit content to screens of any size.
...
* [tiny-ecs](https://github.com/bakpakin/tiny-ecs) ⭐ 775 | 🐛 0 | 🌐 Lua | 📅 2023-03-15 - Entity Component System for Lua that's simple, flexible, and useful.
* [knife.system](https://github.com/airstruck/knife/blob/master/readme/system.md) ⭐ 504 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Minimalist functional ECS.
* [Concord](https://github.com/Keyslam-Group/Concord) ⭐ 302 | 🐛 10 | 🌐 Lua | 📅 2026-01-11 - A feature-complete ECS library.
* [ecs-lua](https://github.com/nidorx/ecs-lua) ⭐ 224 | 🐛 8 | 🌐 Lua | 📅 2024-06-24 - ECS Lua is a fast and easy to use ECS (Entity Component System) engine for game development.
* [evolved.lua](https://github.com/BlackMATov/evolved.lua) ⭐ 171 | 🐛 2 | 🌐 Lua | 📅 2026-02-06 - Evolved ECS (Entity-Component-System) for Lua.
...
* [lume](https://github.com/rxi/lume/) ⭐ 1,211 | 🐛 22 | 🌐 Lua | 📅 2023-11-19 - Collection of functions for Lua, geared towards game development.
* [Simple Tiled Implementation](https://github.com/karai17/Simple-Tiled-Implementation) ⭐ 1,040 | 🐛 31 | 🌐 Lua | 📅 2024-03-24 - Tiled map loader and renderer.
* [knife](https://github.com/airstruck/knife) ⭐ 504 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Collection of useful micro-modules for Lua (Class, State Machines, Bind, Chain, Coroutines, Event, Memoize, Entity, Tests, Timer).
* [batteries](https://github.com/1bardesign/batteries/) ⭐ 422 | 🐛 3 | 🌐 Lua | 📅 2025-09-28 - Fills out lua's sparse standard library and provides implementations of common algorithms and data structures useful for games.
* [lua-state-machine](https://github.com/kyleconroy/lua-state-machine) ⭐ 393 | 🐛 5 | 🌐 Lua | 📅 2025-06-25 - Lua Finite State Machine.
* [rotLove](https://github.com/paulofmandown/rotLove) ⭐ 286 | 🐛 11 | 🌐 Lua | 📅 2022-04-03 - Roguelike Toolkit in LÖVE. A LÖVE/lua port of rot.js.
* [astray](https://github.com/SiENcE/astray) ⭐ 177 | 🐛 0 | 🌐 Lua | 📅 2025-10-11 - A Lua-based maze, room and dungeon generation library for dungeon crawlers and roguelike video games.
...
* [prism](https://github.com/PrismRL/prism) ⭐ 99 | 🐛 52 | 🌐 Lua | 📅 2026-02-07 - A comprehensive traditional roguelike engine.
...
* [shack](https://github.com/Ulydev/shack) ⭐ 67 | 🐛 0 | 🌐 Lua | 📅 2016-04-30 - A LÖVE library that lets you easily add screen effects such as shake and rotation.
* [Love dialogue](https://github.com/Miisan-png/Love-Dialogue) ⭐ 65 | 🐛 0 | 🌐 Lua | 📅 2025-12-18 - Simple to use Dialogue Library for Love2d with custom scripting language for dialogues .
* [Vivid](https://github.com/WetDesertRock/vivid) ⭐ 62 | 🐛 2 | 🌐 Lua | 📅 2020-03-25 - Color math, manipulation and conversion library.
* [Manami](https://github.com/MikuAuahDark/NPad93/blob/master/manami.lua) ⭐ 59 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - An improved "reflowprint" with UTF-8, multicolor, and justify support.
* [roomy](https://github.com/tesselode/roomy) ⭐ 59 | 🐛 1 | 🌐 Lua | 📅 2020-11-11 - Screen management library for LÖVE.
...
* [Scenery](https://github.com/paltze/scenery) ⭐ 47 | 🐛 0 | 🌐 Lua | 📅 2025-01-13 - A dead simple scene/state management system.
...
* [SceneMan](https://github.com/KINGTUT10101/SceneMan) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-11-02 - A simple, but powerful scene/gamestate manager that uses a stack, allowing you to run multiple scenes at once.
...
* [Swipe](https://github.com/zombrodo/swipe) ⭐ 5 | 🐛 0 | 🌐 Lua | 📅 2022-03-28 - A simple radial keyboard library.
...
* [Shädows](https://github.com/matiasah/shadows) ⭐ 180 | 🐛 2 | 🌐 Lua | 📅 2020-07-08 - A Shadows & Lights engine for LÖVE.
* [lighter](https://github.com/speakk/lighter) ⭐ 43 | 🐛 1 | 🌐 Lua | 📅 2023-09-02 - A performant dynamic light implementation with a simple API.
* [Simple Love Lights](https://github.com/dylhunn/simple-love-lights) ⭐ 27 | 🐛 0 | 🌐 Lua | 📅 2020-03-24 - A very simple raycasting light implementation.
...
* [Cirno's Perfect Math Library](https://github.com/excessive/cpml) ⭐ 332 | 🐛 19 | 🌐 Lua | 📅 2023-10-07 - Math/intersection library designed for games.
...
* [vector.lua](https://github.com/automattf/vector.lua) ⭐ 61 | 🐛 2 | 🌐 Lua | 📅 2024-12-03 - A simple vector library based on the PVector class from processing.
* [nvec](https://github.com/MikuAuahDark/NPad93/blob/master/nvec.lua) ⭐ 59 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - Hump.vector-compatible LuaJIT FFI-accelerated 2D vector library.
* [Vornmath](https://github.com/DUznanski/vornmath) ⭐ 20 | 🐛 16 | 🌐 Lua | 📅 2025-12-08 - The most comprehensive small vector & matrix, complex number, and quaternion library for Lua.
...
* [denver](https://github.com/superzazu/denver.lua) ⭐ 95 | 🐛 2 | 🌐 Lua | 📅 2016-05-31 - A Löve custom waveform generation library.
* [ripple](https://github.com/tesselode/ripple) ⭐ 51 | 🐛 5 | 🌐 Lua | 📅 2023-03-22 - An audio manager with tagging support.
* [Lua-Opus](https://github.com/GwyrddGlas/Lua-Opus) ⭐ 2 | 🐛 0 | 🌐 Lua | 📅 2026-01-29 - A module for streaming and decoding Ogg Opus audio files with queueable playback and PCM integration.
...
* [fetch-lua](https://github.com/elloramir/fetch-lua) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2025-06-19 - An HTTPS/HTTP requests library made only with luajjit.

## OO

*Object Orientation Libraries that support [Class-Commons](https://github.com/bartbes/Class-Commons) ⭐ 56 | 🐛 2 | 📅 2018-01-13*

* [middleclass](https://github.com/kikito/middleclass) ⭐ 1,892 | 🐛 0 | 🌐 Lua | 📅 2025-11-03 - Simple OOP library for Lua; has inheritance, metamethods (operators), class variables and weak mixin support (class-commons).
* [classic](https://github.com/rxi/classic/) ⭐ 1,023 | 🐛 19 | 🌐 Lua | 📅 2021-12-31 - Tiny class module for Lua. Attempts to stay simple and provide decent performance by avoiding unnecessary over-abstraction.
* [knife.base](https://github.com/airstruck/knife/blob/master/readme/base.md) ⭐ 504 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Extremely minimal base class providing single inheritance and constructors.
...
* [selene](https://github.com/novafacing/selene) ⭐ 29 | 🐛 0 | 🌐 MoonScript | 📅 2025-06-17 - Project template for writing games in Moonscript instead of Lua without precompiling.
...
* [jprof](https://github.com/pfirsich/jprof) ⭐ 103 | 🐛 9 | 🌐 Lua | 📅 2024-12-16 - Profiling library/tool for LÖVE.
...
* [Bump](https://github.com/kikito/bump.lua) ⭐ 1,070 | 🐛 13 | 🌐 Lua | 📅 2023-09-29 - Collision detection library for Lua.
* [breezefield](https://github.com/HDictus/breezefield) ⭐ 114 | 🐛 4 | 🌐 Lua | 📅 2024-08-12 - A lightweight and easy love.physics wrapper (windfield alternative).
* [slick](https://github.com/erinmaus/slick/) ⭐ 75 | 🐛 5 | 🌐 Lua | 📅 2026-01-21 - A simple to use polygon collision library inspired by bump.lua.
* [Strike](https://github.com/Aweptimum/Strike) ⭐ 31 | 🐛 2 | 🌐 Lua | 📅 2023-09-15 - 2D collision detection library. Extendable, based on Separating-Axis-Theorem.
...
* [LÖVR](https://github.com/bjornbytes/lovr) ⭐ 2,484 | 🐛 28 | 🌐 C | 📅 2026-02-06 - LÖVE for virtual reality devices.
* [Love.js](https://github.com/Davidobot/love.js) ⭐ 798 | 🐛 68 | 🌐 JavaScript | 📅 2024-05-13 - LÖVE ported to the web using Emscripten.
* [LoveDos](https://github.com/rxi/lovedos) ⚠️ Archived - A Lua framework for 2D DOS games, implementing a subset of the LÖVE API.
* [LÖVE Potion](https://github.com/lovebrew/lovepotion) ⭐ 654 | 🐛 3 | 🌐 C++ | 📅 2026-02-06 - Unofficial implementation of the LÖVE for Nintendo (3DS, Switch and Wii U) Homebrew.
...
* [knife.serialize](https://github.com/airstruck/knife/blob/master/readme/serialize.md) ⭐ 504 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Serialize data as a Lua script.
* [binser](https://github.com/bakpakin/binser) ⭐ 215 | 🐛 3 | 🌐 Lua | 📅 2023-03-02 - Customizable Lua Serializer.
* [bitser](https://github.com/gvx/bitser) ⭐ 177 | 🐛 5 | 🌐 Lua | 📅 2025-01-31 - Serializes and deserializes Lua values with LuaJIT.
* [Ser](https://github.com/gvx/Ser) ⭐ 82 | 🐛 0 | 🌐 Lua | 📅 2016-05-19 - Fast, robust, richly-featured table serialization library for Lua.
...
* [arson](https://github.com/flamendless/arson.lua) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2023-05-21 - Companion library for registering custom data types that can be encoded and decoded by json.lua.

## Shaders

*GLSL related Libraries*

* [Moonshine](https://github.com/vrld/moonshine) ⭐ 692 | 🐛 18 | 🌐 Lua | 📅 2023-12-23 - Repository of common post-processing effects like blur, vignette, color-grading, etc.
* [LoveShaderConverter](https://github.com/tsteinholz/LoveShaderConverter) ⭐ 94 | 🐛 2 | 🌐 C++ | 📅 2016-06-25 - Convert Shadertoy Shader files to LÖVE GLSL Files with handy utilities for infinite purposes.
* [ngrading](https://github.com/MikuAuahDark/NPad93/tree/master/ngrading) ⭐ 59 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - Simple color grading library.
* [ShaderScan](https://github.com/idbrii/love-shaderscan) ⭐ 13 | 🐛 1 | 🌐 Lua | 📅 2023-09-08 - Adds hot reload, includes, and better error messages for faster shader iteration.

## Testing

*Libraries and Tools for Unit Testing*

* [busted](https://github.com/lunarmodules/busted) ⭐ 1,586 | 🐛 61 | 🌐 Lua | 📅 2026-01-23 - Simple unit-testing framework with customizable assertions.
* [knife.test](https://github.com/airstruck/knife/blob/master/readme/test.md) ⭐ 504 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Fixture-free test framework.
* [Luassert](https://github.com/lunarmodules/luassert) ⭐ 241 | 🐛 9 | 🌐 Lua | 📅 2024-11-07 - Extends `assert()` with additional, customizable tests.
* [lust](https://github.com/bjornbytes/lust) ⭐ 125 | 🐛 0 | 🌐 Lua | 📅 2024-10-03 - Minimal test framework.
* [Lunatest](https://github.com/silentbicycle/lunatest) ⭐ 85 | 🐛 9 | 🌐 Lua | 📅 2022-05-07 - xUnit-style randomized unit testing framework.
...
* [tween.lua](https://github.com/kikito/tween.lua) ⭐ 661 | 🐛 7 | 🌐 Lua | 📅 2023-02-02 - Tweening/Easing/Interpolating functions for Lua inspired on jQuery's animate method.
* [knife.timer](https://github.com/airstruck/knife/blob/master/readme/timer.md) ⭐ 504 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Create timers and tweens with ease.
* [Flux](https://github.com/rxi/flux) ⭐ 467 | 🐛 9 | 🌐 Lua | 📅 2020-12-16 - A fast, lightweight tweening library for Lua.
* [tick](https://github.com/rxi/tick) ⭐ 192 | 🐛 0 | 🌐 Lua | 📅 2015-03-11 - Lua module for delaying function calls.
* [NAniTe](https://github.com/MikuAuahDark/NPad93/blob/master/nanite.lua) ⭐ 59 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - Timeline-based animation system that supports forward and backward update.
...
* [SUIT](https://github.com/vrld/SUIT) ⭐ 522 | 🐛 18 | 🌐 Lua | 📅 2023-08-26 - Small immediate mode GUI library.
* [Löve-Nuklear](https://github.com/keharriso/love-nuklear) ⭐ 381 | 🐛 6 | 🌐 C | 📅 2025-02-14 - Lightweight immediate mode GUI for LÖVE games.
* [Slab](https://github.com/flamendless/Slab) ⭐ 365 | 🐛 25 | 🌐 Lua | 📅 2026-02-05 - An immediate mode GUI toolkit for the LÖVE framework.
* [Love Imgui](https://github.com/slages/love-imgui) ⭐ 347 | 🐛 28 | 🌐 C++ | 📅 2023-12-03 - Imgui module for the LÖVE game engine.
* [GOOi](https://github.com/gustavostuff/gooi) ⭐ 234 | 🐛 5 | 🌐 Lua | 📅 2023-09-06 - Android-oriented GUI library.
* [LoveFrames Fork](https://github.com/linux-man/LoveFrames) ⭐ 150 | 🐛 4 | 🌐 Lua | 📅 2025-10-22 - 11.2 Fork of a GUI library.
...
* [CatUI](https://github.com/wilhantian/catui) ⭐ 114 | 🐛 4 | 🌐 Lua | 📅 2022-06-02 - A very light-weight GUI library for LÖVE.
* [Luis](https://github.com/SiENcE/luis) ⭐ 102 | 🐛 1 | 🌐 Lua | 📅 2025-10-19 - Love UI System - A retained mode UI framework for LÖVE with input processing (mouse, keyboard, touch, gamepad), layer-, grid-, state-, theming-system, UI editor, 16+ widgets (for desktop & mobile).
* [Inky](https://github.com/Keyslam/Inky) ⭐ 82 | 🐛 4 | 🌐 Lua | 📅 2025-12-20 - Any-purpose GUI framework.
* [lovr-ui2d](https://github.com/immortalx74/lovr-ui2d) ⭐ 72 | 🐛 0 | 🌐 Lua | 📅 2025-11-21 - An immediate mode GUI library for LÖVR and LÖVE.
* [NLay](https://github.com/MikuAuahDark/NPad93#nlay) ⭐ 59 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - Flexible layouting library.
* [Badar 🌕](https://github.com/Nabeel20/Badr) ⭐ 40 | 🐛 0 | 🌐 Lua | 📅 2024-10-04 - Simple **custom UI syntax** for easy components compositions.
* [Patchy](https://github.com/excessive/patchy) ⭐ 38 | 🐛 1 | 🌐 Lua | 📅 2019-03-27 - 9patch library.
* [Plan](https://github.com/zombrodo/plan) ⭐ 27 | 🐛 0 | 🌐 Lua | 📅 2023-10-01 - A super simple Rule-based layout library.
* [Layouter](https://github.com/nekromoff/layouter) ⭐ 20 | 🐛 1 | 🌐 Lua | 📅 2024-04-22 - A simple UI **grid layout** library for LÖVE 2D game engine.
* [LOVELi](https://github.com/mtanksl/LOVELi) ⭐ 17 | 🐛 0 | 🌐 Lua | 📅 2025-10-01 - Retained mode layout and GUI library inspired by .NET's MAUI controls with StackLayout, AbsoluteLayout, Grid, Label, Button, Image, CheckBox, RadioButton, Switch, ProgressBar, Slider, TextBox and Border.
...
* [YALG](https://github.com/sasszem/yalg) ⭐ 11 | 🐛 2 | 🌐 Lua | 📅 2020-08-25 - A very simple, cross-platform, reactive UI for last minute UIs.
* [ProdUI](https://github.com/frank-f-trafton/prod_ui_wip) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-02-06 - A user interface library for the LÖVE Framework.
* [FlexLöve](https://github.com/mikefreno/FlexLove) ⭐ 9 | 🐛 0 | 🌐 Lua | 📅 2026-01-06 - A fully featured GUI library, supporting flexbox/grid/absolute layouts, both immediate and retained mode, 9patch theming and advanced event support.
* [TuxRedux](https://github.com/KINGTUT10101/TuxRedux) ⭐ 5 | 🐛 0 | 🌐 Lua | 📅 2026-01-29 - An immediate-mode UI system for LOVE2D inspired by SUIT.
...
* [log.lua](https://github.com/rxi/log.lua) ⭐ 353 | 🐛 5 | 🌐 Lua | 📅 2023-08-23 - Library for configurable log output.
* [luasteam](https://github.com/uspgamedev/luasteam) ⭐ 212 | 🐛 8 | 🌐 C++ | 📅 2026-01-19 - Lua bindings for the Steamworks API.
...
* [tick](https://github.com/bjornbytes/tick) ⭐ 95 | 🐛 2 | 🌐 Lua | 📅 2021-02-17 - Useful timing tweaks for LÖVE's run loop.
...
* [nativefs](https://github.com/EngineerSmith/nativefs) ⭐ 48 | 🐛 1 | 🌐 Lua | 📅 2024-05-02 - Read and write files outside of LÖVE's allowed paths.
* [splashy](https://github.com/videah/splashy) ⭐ 42 | 🐛 5 | 🌐 Lua | 📅 2023-11-04 - Splash Screen Library.
* [love2d-assets-loader](https://github.com/Yonaba/love2d-assets-loader) ⭐ 40 | 🐛 4 | 🌐 Lua | 📅 2021-05-29 - Assets Loader.
* [smiti18n](https://github.com/Oval-Tutu/smiti18n) ⭐ 38 | 🐛 3 | 🌐 Lua | 📅 2025-12-15 - A very complete internationalization library for Lua with LÖVE support.
...
* [lovely-engine](https://github.com/vinnyhorgan/lovely-engine) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2021-07-30 - A tool that makes setting up and using LÖVE easier and with Moonscript support.
* [hex2color](https://github.com/swalrus1/hex2color) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2019-11-07 - A single function to use HEX color values.
* [andromeda](https://github.com/itzKiwiSky/Andromeda) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2024-07-22 - Asset database and loader for love.
...
* [IntelliJ IDEA](https://www.jetbrains.com/idea/) - Capable and Ergonomic Java IDE.
  * [EmmyLua](https://github.com/EmmyLua/VSCode-EmmyLua) ⭐ 720 | 🐛 27 | 🌐 TypeScript | 📅 2026-02-02 - Lua IDE/Debugger Plugin for VSCode.
...
* [Zed](https://zed.dev) - A next-generation code editor designed for high-performance collaboration, written in Rust.
  * [love2d](https://github.com/LuaCATS/love2d) ⭐ 60 | 🐛 4 | 🌐 Lua | 📅 2024-12-03 - LuaCATS typing hints for the lua language server.
...
* [AppImageKit](https://github.com/AppImage/AppImageKit) ⭐ 9,254 | 🐛 234 | 🌐 C | 📅 2025-06-09 - Using AppImageKit you can package LÖVE games as AppImages that run on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, Debian and derivatives; one game = one file.
...
* [makelove](https://github.com/pfirsich/makelove) ⭐ 191 | 🐛 24 | 🌐 Python | 📅 2024-06-08 - Advanced multi-platform tool to fuse your game written in Python 3. Supports Windows and Linux with AppImage.
* [boon](https://github.com/camchenry/boon) ⭐ 154 | 🐛 5 | 🌐 Rust | 📅 2024-01-07 - Multi-platform, easy to use tool supporting Windows, macOS, Linux.
* [LÖVE Game Development & Automated Build System](https://github.com/Oval-Tutu/bootstrap-love2d-project) ⭐ 153 | 🐛 11 | 🌐 Lua | 📅 2025-12-15 - Preconfigured VSCode/Codium. Build for Android, iOS, HTML5, Linux, macOS and Windows and automatically publish to Itch.io.
* [love-build](https://github.com/ellraiser/love-build) ⭐ 78 | 🐛 2 | 🌐 Lua | 📅 2025-05-30 - Downloadable application (made in LÖVE!) that can build games for Windows, macOS, and Linux regardless of your own OS.
...
* [lover](https://github.com/Wolfyxon/lover) ⭐ 44 | 🐛 2 | 🌐 Rust | 📅 2025-11-11 - Bringing the joys of rust's package manager (`Cargo`) to love.
...
* [love-fuser](https://github.com/MikuAuahDark/love-fuser) ⭐ 19 | 🐛 3 | 🌐 Lua | 📅 2023-07-08 - Packages LÖVE Games using GitHub Actions. Supports Windows, Linux, and Android.
...
* [lovesfx](https://github.com/tpimh/lovesfx) ⭐ 11 | 🐛 0 | 🌐 Shell | 📅 2024-07-29 - Packs love games in a single file for windows.
...
* [awesome-lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,454 | 🐛 47 | 📅 2024-08-11 - A list like this one, but more general and encompassing all of Lua's uses.
* [awesome-pico8](https://github.com/pico-8/awesome-PICO-8) ⭐ 2,962 | 🐛 1 | 📅 2025-12-03 - A curated list of PICO-8 resources, tutorials, tools and more.
...
Other awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,201 | 🐛 43 | 🌐 Ruby | 📅 2024-06-02 list.
