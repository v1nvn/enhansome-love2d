# Awesome Löve [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 470,669 | 🐛 78 | 📅 2026-05-05 with stars
...
* [g3d](https://github.com/groverburger/g3d) ⭐ 803 | 🐛 3 | 🌐 Lua | 📅 2026-05-03 - Simple and easy 3D engine for LÖVE.
* [3DreamEngine](https://github.com/3dreamengine/3DreamEngine) ⭐ 477 | 🐛 14 | 🌐 Lua | 📅 2023-05-25 - An awesome 3D engine for LÖVE.
* [Menori](https://github.com/rozenmad/Menori) ⭐ 283 | 🐛 6 | 🌐 Lua | 📅 2025-08-26 - Library for 3D rendering with LÖVE.
...
* [Jumper](https://github.com/Yonaba/Jumper) ⭐ 645 | 🐛 39 | 🌐 Lua | 📅 2022-10-21 - Grid-based pathfinding library.
* [Lua-star](https://github.com/wesleywerner/lua-star) ⭐ 80 | 🐛 0 | 🌐 Lua | 📅 2021-07-25 - Easy and pure Lua A\* path finding.
...
* [FluadHTN](https://github.com/Safebox36/OdaiHTN) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2026-03-19 - A powerful hierarchical task network for AI planning.
...
* [anim8](https://github.com/kikito/anim8) ⭐ 966 | 🐛 7 | 🌐 Lua | 📅 2022-01-20 - Animation library.
...
* [Peachy](https://github.com/josh-perry/peachy) ⭐ 111 | 🐛 0 | 🌐 Lua | 📅 2026-05-04 - A parser/renderer for Aseprite animations in LÖVE.
...
* [lurker](https://github.com/rxi/lurker) ⭐ 369 | 🐛 7 | 🌐 Lua | 📅 2023-07-22 - Auto-swaps changed Lua files in a running game.
* [LÖVE API](https://github.com/love2d-community/love-api) ⭐ 365 | 🐛 13 | 🌐 Lua | 📅 2026-05-07 - The complete API documentation of LÖVE in a Lua table.
* [Lovebird](https://github.com/rxi/lovebird) ⭐ 334 | 🐛 6 | 🌐 Lua | 📅 2021-05-08 - Browser-based debug console.
...
* [LÖVE Build](https://github.com/nhartland/love-build) ⭐ 75 | 🐛 3 | 🌐 Shell | 📅 2026-03-03 - GitHub Action for automated cross-platform builds.
...
* [feather](https://github.com/Kyonru/feather) ⭐ 32 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-27 - Extensible Development Toolkit for LÖVE. Step by step debugger, hot reloading, remote log inspection, easy android and ios development builds, assisted release and upload, shader graph, particle system playground, and more!
...
* [Push](https://github.com/Ulydev/push) ⭐ 646 | 🐛 16 | 🌐 Lua | 📅 2023-09-25 - A simple resolution-handling library for LÖVE.
* [Autobatch](https://github.com/rxi/autobatch) ⭐ 122 | 🐛 1 | 🌐 Lua | 📅 2018-09-10 - Small LÖVE module to automate the use of SpriteBatches.
* [deep](https://github.com/Nikaoto/deep) ⭐ 106 | 🐛 1 | 🌐 Lua | 📅 2026-02-17 - Adds Z axis; allows you to queue actions and draw calls.
...
* [Hot particles](https://github.com/ReFreezed/HotParticles) ⭐ 68 | 🐛 0 | 🌐 Lua | 📅 2022-03-20 - "Hot Particles is a particle editor for the LÖVE game framework."
...
* [tiny-ecs](https://github.com/bakpakin/tiny-ecs) ⭐ 781 | 🐛 0 | 🌐 Lua | 📅 2023-03-15 - Entity Component System for Lua that's simple, flexible, and useful.
* [knife.system](https://github.com/airstruck/knife/blob/master/readme/system.md) ⭐ 513 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Minimalist functional ECS.
* [Concord](https://github.com/Keyslam-Group/Concord) ⭐ 317 | 🐛 10 | 🌐 Lua | 📅 2026-01-11 - A feature-complete ECS library.
* [ecs-lua](https://github.com/nidorx/ecs-lua) ⭐ 227 | 🐛 8 | 🌐 Lua | 📅 2024-06-24 - ECS Lua is a fast and easy to use ECS (Entity Component System) engine for game development.
* [evolved.lua](https://github.com/BlackMATov/evolved.lua) ⭐ 210 | 🐛 1 | 🌐 Lua | 📅 2026-04-08 - Evolved ECS (Entity-Component-System) for Lua.
...
* [lume](https://github.com/rxi/lume/) ⭐ 1,224 | 🐛 22 | 🌐 Lua | 📅 2023-11-19 - Collection of functions for Lua, geared towards game development.
* [Simple Tiled Implementation](https://github.com/karai17/Simple-Tiled-Implementation) ⭐ 1,048 | 🐛 32 | 🌐 Lua | 📅 2024-03-24 - Tiled map loader and renderer.
* [knife](https://github.com/airstruck/knife) ⭐ 513 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Collection of useful micro-modules for Lua (Class, State Machines, Bind, Chain, Coroutines, Event, Memoize, Entity, Tests, Timer).
* [batteries](https://github.com/1bardesign/batteries/) ⭐ 427 | 🐛 3 | 🌐 Lua | 📅 2026-05-26 - Fills out lua's sparse standard library and provides implementations of common algorithms and data structures useful for games.
* [lua-state-machine](https://github.com/kyleconroy/lua-state-machine) ⭐ 402 | 🐛 5 | 🌐 Lua | 📅 2025-06-25 - Lua Finite State Machine.
...
* [narrator](https://github.com/astrochili/narrator) ⭐ 165 | 🐛 15 | 🌐 Lua | 📅 2024-05-09 - An Ink narrative scripting language parser and runtime implementation.
* [prism](https://github.com/PrismRL/prism) ⭐ 116 | 🐛 51 | 🌐 Lua | 📅 2026-05-18 - A comprehensive traditional roguelike engine.
...
* [cartographer](https://github.com/tesselode/cartographer) ⭐ 76 | 🐛 3 | 🌐 Lua | 📅 2020-11-28 - Small Tiled map loader and drawer.
* [Love dialogue](https://github.com/Miisan-png/Love-Dialogue) ⭐ 73 | 🐛 0 | 🌐 Lua | 📅 2025-12-18 - Simple to use Dialogue Library for Love2d with custom scripting language for dialogues .
...
* [Manami](https://github.com/MikuAuahDark/NPad93/blob/master/manami.lua) ⭐ 64 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - An improved "reflowprint" with UTF-8, multicolor, and justify support.
...
* [Scenery](https://github.com/paltze/scenery) ⭐ 49 | 🐛 0 | 🌐 Lua | 📅 2025-01-13 - A dead simple scene/state management system.
...
* [baton](https://github.com/tesselode/baton) ⭐ 257 | 🐛 6 | 🌐 Lua | 📅 2022-11-18 -  Input library for LÖVE that bridges the gap between keyboard and gamepad controls.
* [love-microphone](https://github.com/LPGhatguy/love-microphone) ⭐ 63 | 🐛 4 | 🌐 Lua | 📅 2017-12-11 - Simple microphone support for LÖVE.
...
* [lighter](https://github.com/speakk/lighter) ⭐ 43 | 🐛 1 | 🌐 Lua | 📅 2026-02-08 - A performant dynamic light implementation with a simple API.
...
* [Light](https://github.com/xiejiangzhi/light) ⭐ 16 | 🐛 0 | 🌐 Lua | 📅 2019-09-17 - A simple dynamic light implementation.
...
* [Cirno's Perfect Math Library](https://github.com/excessive/cpml) ⭐ 344 | 🐛 17 | 🌐 Lua | 📅 2026-02-11 - Math/intersection library designed for games.
...
* [brinevector](https://github.com/novemberisms/brinevector) ⭐ 64 | 🐛 2 | 🌐 Lua | 📅 2022-08-21 - Standalone lightweight luajit ffi-accelerated 2D vector library for great performance.
* [nvec](https://github.com/MikuAuahDark/NPad93/blob/master/nvec.lua) ⭐ 64 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - Hump.vector-compatible LuaJIT FFI-accelerated 2D vector library.
...
* [Vornmath](https://github.com/DUznanski/vornmath) ⭐ 22 | 🐛 12 | 🌐 Lua | 📅 2026-05-23 - The most comprehensive small vector & matrix, complex number, and quaternion library for Lua.
...
* [lovebpm](https://github.com/rxi/lovebpm) ⭐ 99 | 🐛 1 | 🌐 Lua | 📅 2021-08-06 - A LÖVE library for syncing events to the BPM of an audio track.
...
* [NoobHub](https://github.com/Overtorment/NoobHub) ⭐ 353 | 🐛 2 | 🌐 Lua | 📅 2024-07-16 - OpenSource multiplayer and network messaging. (IPv6)
...
* [middleclass](https://github.com/kikito/middleclass) ⭐ 1,910 | 🐛 1 | 🌐 Lua | 📅 2025-11-03 - Simple OOP library for Lua; has inheritance, metamethods (operators), class variables and weak mixin support (class-commons).
* [classic](https://github.com/rxi/classic/) ⭐ 1,048 | 🐛 19 | 🌐 Lua | 📅 2021-12-31 - Tiny class module for Lua. Attempts to stay simple and provide decent performance by avoiding unnecessary over-abstraction.
* [knife.base](https://github.com/airstruck/knife/blob/master/readme/base.md) ⭐ 513 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Extremely minimal base class providing single inheritance and constructors.
...
* [Bump](https://github.com/kikito/bump.lua) ⭐ 1,080 | 🐛 13 | 🌐 Lua | 📅 2023-09-29 - Collision detection library for Lua.
...
* [slick](https://github.com/erinmaus/slick/) ⭐ 80 | 🐛 6 | 🌐 Lua | 📅 2026-04-08 - A simple to use polygon collision library inspired by bump.lua.
...
* [LÖVR](https://github.com/bjornbytes/lovr) ⭐ 2,545 | 🐛 19 | 🌐 C | 📅 2026-05-28 - LÖVE for virtual reality devices.
* [LoveDos](https://github.com/rxi/lovedos) ⚠️ Archived - A Lua framework for 2D DOS games, implementing a subset of the LÖVE API.
* [LÖVE Potion](https://github.com/lovebrew/lovepotion) ⭐ 676 | 🐛 5 | 🌐 C++ | 📅 2026-05-12 - Unofficial implementation of the LÖVE for Nintendo (3DS, Switch and Wii U) Homebrew.
...
* [knife.serialize](https://github.com/airstruck/knife/blob/master/readme/serialize.md) ⭐ 513 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Serialize data as a Lua script.
* [binser](https://github.com/bakpakin/binser) ⭐ 213 | 🐛 3 | 🌐 Lua | 📅 2023-03-02 - Customizable Lua Serializer.
* [bitser](https://github.com/gvx/bitser) ⭐ 179 | 🐛 5 | 🌐 Lua | 📅 2025-01-31 - Serializes and deserializes Lua values with LuaJIT.
...
* [Moonshine](https://github.com/vrld/moonshine) ⭐ 710 | 🐛 19 | 🌐 Lua | 📅 2023-12-23 - Repository of common post-processing effects like blur, vignette, color-grading, etc.
...
* [ngrading](https://github.com/MikuAuahDark/NPad93/tree/master/ngrading) ⭐ 64 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - Simple color grading library.
...
* [busted](https://github.com/lunarmodules/busted) ⭐ 1,614 | 🐛 65 | 🌐 Lua | 📅 2026-03-19 - Simple unit-testing framework with customizable assertions.
* [knife.test](https://github.com/airstruck/knife/blob/master/readme/test.md) ⭐ 513 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Fixture-free test framework.
* [Luassert](https://github.com/lunarmodules/luassert) ⭐ 243 | 🐛 10 | 🌐 Lua | 📅 2024-11-07 - Extends `assert()` with additional, customizable tests.
* [lust](https://github.com/bjornbytes/lust) ⭐ 131 | 🐛 0 | 🌐 Lua | 📅 2024-10-03 - Minimal test framework.
...
* [knife.timer](https://github.com/airstruck/knife/blob/master/readme/timer.md) ⭐ 513 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Create timers and tweens with ease.
* [Flux](https://github.com/rxi/flux) ⭐ 476 | 🐛 9 | 🌐 Lua | 📅 2020-12-16 - A fast, lightweight tweening library for Lua.
* [tick](https://github.com/rxi/tick) ⭐ 202 | 🐛 0 | 🌐 Lua | 📅 2015-03-11 - Lua module for delaying function calls.
* [NAniTe](https://github.com/MikuAuahDark/NPad93/blob/master/nanite.lua) ⭐ 64 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - Timeline-based animation system that supports forward and backward update.
...
* [SUIT](https://github.com/vrld/SUIT) ⭐ 534 | 🐛 18 | 🌐 Lua | 📅 2023-08-26 - Small immediate mode GUI library.
* [Löve-Nuklear](https://github.com/keharriso/love-nuklear) ⭐ 389 | 🐛 6 | 🌐 C | 📅 2025-02-14 - Lightweight immediate mode GUI for LÖVE games.
* [Slab](https://github.com/flamendless/Slab) ⭐ 382 | 🐛 26 | 🌐 Lua | 📅 2026-03-23 - An immediate mode GUI toolkit for the LÖVE framework.
* [Love Imgui](https://github.com/slages/love-imgui) ⭐ 349 | 🐛 27 | 🌐 C++ | 📅 2023-12-03 - Imgui module for the LÖVE game engine.
* [LuaJIT-ImGui](https://github.com/sonoro1234/LuaJIT-ImGui) ⭐ 293 | 🐛 8 | 🌐 Lua | 📅 2026-05-27 - LuaJIT bindings for Dear ImGui with a LÖVE module; supports all cimgui widgets using cpp names for easy example copying.
* [GOOi](https://github.com/gustavostuff/gooi) ⭐ 236 | 🐛 5 | 🌐 Lua | 📅 2023-09-06 - Android-oriented GUI library.
...
* [Luis](https://github.com/SiENcE/luis) ⭐ 117 | 🐛 1 | 🌐 Lua | 📅 2026-03-01 - Love UI System - A retained mode UI framework for LÖVE with input processing (mouse, keyboard, touch, gamepad), layer-, grid-, state-, theming-system, UI editor, 16+ widgets (for desktop & mobile).
* [CatUI](https://github.com/wilhantian/catui) ⭐ 114 | 🐛 4 | 🌐 Lua | 📅 2022-06-02 - A very light-weight GUI library for LÖVE.
* [Inky](https://github.com/Keyslam/Inky) ⭐ 83 | 🐛 4 | 🌐 Lua | 📅 2025-12-20 - Any-purpose GUI framework.
* [lovr-ui2d](https://github.com/immortalx74/lovr-ui2d) ⭐ 77 | 🐛 0 | 🌐 Lua | 📅 2025-11-21 - An immediate mode GUI library for LÖVR and LÖVE.
* [NLay](https://github.com/MikuAuahDark/NPad93#nlay) ⭐ 64 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - Flexible layouting library.
* [Badar 🌕](https://github.com/Nabeel20/Badr) ⭐ 43 | 🐛 0 | 🌐 Lua | 📅 2024-10-04 - Simple **custom UI syntax** for easy components compositions.
* [Patchy](https://github.com/excessive/patchy) ⭐ 38 | 🐛 1 | 🌐 Lua | 📅 2019-03-27 - 9patch library.
* [LOVELi](https://github.com/mtanksl/LOVELi) ⭐ 35 | 🐛 0 | 🌐 Lua | 📅 2026-04-12 - Retained mode layout and GUI library inspired by .NET's MAUI controls with StackLayout, AbsoluteLayout, Grid, Label, Button, Image, CheckBox, RadioButton, Switch, ProgressBar, Slider, TextBox and Border.
* [FlexLöve](https://github.com/mikefreno/FlexLove) ⭐ 30 | 🐛 1 | 🌐 Lua | 📅 2026-05-22 - A fully featured GUI library, supporting flexbox/grid/absolute layouts, both immediate and retained mode, 9patch theming and advanced event support.
* [Plan](https://github.com/zombrodo/plan) ⭐ 28 | 🐛 0 | 🌐 Lua | 📅 2026-03-02 - A super simple Rule-based layout library.
* [Layouter](https://github.com/nekromoff/layouter) ⭐ 19 | 🐛 1 | 🌐 Lua | 📅 2024-04-22 - A simple UI **grid layout** library for LÖVE 2D game engine.
...
* [log.lua](https://github.com/rxi/log.lua) ⭐ 357 | 🐛 6 | 🌐 Lua | 📅 2023-08-23 - Library for configurable log output.
* [luasteam](https://github.com/uspgamedev/luasteam) ⭐ 229 | 🐛 1 | 🌐 C++ | 📅 2026-04-09 - Lua bindings for the Steamworks API.
* [cargo](https://github.com/bjornbytes/cargo) ⭐ 182 | 🐛 2 | 🌐 Lua | 📅 2020-02-02 - Asset manager.
...
* [nativefs](https://github.com/EngineerSmith/nativefs) ⭐ 50 | 🐛 1 | 🌐 Lua | 📅 2024-05-02 - Read and write files outside of LÖVE's allowed paths.
...
* [IntelliJ IDEA](https://www.jetbrains.com/idea/) - Capable and Ergonomic Java IDE.
  * [EmmyLua](https://github.com/EmmyLua/VSCode-EmmyLua) ⭐ 739 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-14 - Lua IDE/Debugger Plugin for VSCode.
...
* [Zed](https://zed.dev) - A next-generation code editor designed for high-performance collaboration, written in Rust.
  * [love2d](https://github.com/LuaCATS/love2d) ⭐ 70 | 🐛 3 | 🌐 Lua | 📅 2026-05-06 - LuaCATS typing hints for the lua language server.
...
* [AppImageKit](https://github.com/AppImage/AppImageKit) ⭐ 9,345 | 🐛 236 | 🌐 C | 📅 2025-06-09 - Using AppImageKit you can package LÖVE games as AppImages that run on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, Debian and derivatives; one game = one file.
...
* [makelove](https://github.com/pfirsich/makelove) ⭐ 203 | 🐛 26 | 🌐 Python | 📅 2026-04-27 - Advanced multi-platform tool to fuse your game written in Python 3. Supports Windows and Linux with AppImage.
* [LÖVE Game Development & Automated Build System](https://github.com/Oval-Tutu/bootstrap-love2d-project) ⭐ 174 | 🐛 14 | 🌐 Lua | 📅 2025-12-15 - Preconfigured VSCode/Codium. Build for Android, iOS, HTML5, Linux, macOS and Windows and automatically publish to Itch.io.
* [boon](https://github.com/camchenry/boon) ⭐ 160 | 🐛 5 | 🌐 Rust | 📅 2026-04-02 - Multi-platform, easy to use tool supporting Windows, macOS, Linux.
* [love-build](https://github.com/ellraiser/love-build) ⭐ 91 | 🐛 3 | 🌐 Lua | 📅 2025-05-30 - Downloadable application (made in LÖVE!) that can build games for Windows, macOS, and Linux regardless of your own OS.
...
* [lover](https://github.com/Wolfyxon/lover) ⭐ 46 | 🐛 2 | 🌐 Rust | 📅 2026-04-29 - Bringing the joys of rust's package manager (`Cargo`) to love.
...
* [love-deploy](https://github.com/tducasse/love-deploy) ⭐ 14 | 🐛 0 | 🌐 Makefile | 📅 2024-04-07 - Build and deploy games on itch.io (supports windows and web exports).
...
* [awesome-lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,510 | 🐛 47 | 📅 2024-08-11 - A list like this one, but more general and encompassing all of Lua's uses.
* [awesome-pico8](https://github.com/pico-8/awesome-PICO-8) ⭐ 3,016 | 🐛 0 | 📅 2026-02-18 - A curated list of PICO-8 resources, tutorials, tools and more.
...
Other awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,446 | 🐛 54 | 🌐 Ruby | 📅 2024-06-02 list.
