# Awesome Löve [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 443,494 | 🐛 73 | 📅 2026-03-04 with stars
...
* [g3d](https://github.com/groverburger/g3d) ⭐ 768 | 🐛 2 | 🌐 Lua | 📅 2025-12-16 - Simple and easy 3D engine for LÖVE.
* [3DreamEngine](https://github.com/3dreamengine/3DreamEngine) ⭐ 469 | 🐛 14 | 🌐 Lua | 📅 2023-05-25 - An awesome 3D engine for LÖVE.
* [Menori](https://github.com/rozenmad/Menori) ⭐ 273 | 🐛 6 | 🌐 Lua | 📅 2025-08-26 - Library for 3D rendering with LÖVE.
...
* [IQM](https://github.com/excessive/iqm-exm) ⭐ 41 | 🐛 7 | 🌐 Python | 📅 2021-06-04 - Inter-Quake Model loader (binary).
...
* [anim8](https://github.com/kikito/anim8) ⭐ 949 | 🐛 7 | 🌐 Lua | 📅 2022-01-20 - Animation library.
...
* [lurker](https://github.com/rxi/lurker) ⭐ 365 | 🐛 7 | 🌐 Lua | 📅 2023-07-22 - Auto-swaps changed Lua files in a running game.
* [LÖVE API](https://github.com/love2d-community/love-api) ⭐ 359 | 🐛 14 | 🌐 Lua | 📅 2025-04-13 - The complete API documentation of LÖVE in a Lua table.
* [Lovebird](https://github.com/rxi/lovebird) ⭐ 331 | 🐛 6 | 🌐 Lua | 📅 2021-05-08 - Browser-based debug console.
...
* [LÖVE Build](https://github.com/nhartland/love-build) ⭐ 73 | 🐛 3 | 🌐 Shell | 📅 2026-03-03 - GitHub Action for automated cross-platform builds.
...
* [Push](https://github.com/Ulydev/push) ⭐ 620 | 🐛 16 | 🌐 Lua | 📅 2023-09-25 - A simple resolution-handling library for LÖVE.
...
* [Shöve](https://github.com/Oval-Tutu/shove) ⭐ 92 | 🐛 3 | 🌐 Lua | 📅 2025-05-23 - A powerful resolution-handler and rendering library for LÖVE.
...
* [Runtime-TextureAtlas](https://github.com/EngineerSmith/Runtime-TextureAtlas) ⭐ 26 | 🐛 0 | 🌐 Lua | 📅 2025-11-13 - Texture atlas packer and renderer at runtime; no external tools.
...
* [knife.system](https://github.com/airstruck/knife/blob/master/readme/system.md) ⭐ 505 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Minimalist functional ECS.
* [Concord](https://github.com/Keyslam-Group/Concord) ⭐ 305 | 🐛 10 | 🌐 Lua | 📅 2026-01-11 - A feature-complete ECS library.
* [ecs-lua](https://github.com/nidorx/ecs-lua) ⭐ 225 | 🐛 8 | 🌐 Lua | 📅 2024-06-24 - ECS Lua is a fast and easy to use ECS (Entity Component System) engine for game development.
* [evolved.lua](https://github.com/BlackMATov/evolved.lua) ⭐ 190 | 🐛 1 | 🌐 Lua | 📅 2026-03-05 - Evolved ECS (Entity-Component-System) for Lua.
...
* [lume](https://github.com/rxi/lume/) ⭐ 1,215 | 🐛 22 | 🌐 Lua | 📅 2023-11-19 - Collection of functions for Lua, geared towards game development.
* [Simple Tiled Implementation](https://github.com/karai17/Simple-Tiled-Implementation) ⭐ 1,043 | 🐛 31 | 🌐 Lua | 📅 2024-03-24 - Tiled map loader and renderer.
* [knife](https://github.com/airstruck/knife) ⭐ 505 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Collection of useful micro-modules for Lua (Class, State Machines, Bind, Chain, Coroutines, Event, Memoize, Entity, Tests, Timer).
* [batteries](https://github.com/1bardesign/batteries/) ⭐ 425 | 🐛 3 | 🌐 Lua | 📅 2025-09-28 - Fills out lua's sparse standard library and provides implementations of common algorithms and data structures useful for games.
...
* [astray](https://github.com/SiENcE/astray) ⭐ 181 | 🐛 0 | 🌐 Lua | 📅 2025-10-11 - A Lua-based maze, room and dungeon generation library for dungeon crawlers and roguelike video games.
* [narrator](https://github.com/astrochili/narrator) ⭐ 160 | 🐛 15 | 🌐 Lua | 📅 2024-05-09 - An Ink narrative scripting language parser and runtime implementation.
* [prism](https://github.com/PrismRL/prism) ⭐ 106 | 🐛 51 | 🌐 Lua | 📅 2026-02-25 - A comprehensive traditional roguelike engine.
...
* [Love dialogue](https://github.com/Miisan-png/Love-Dialogue) ⭐ 66 | 🐛 0 | 🌐 Lua | 📅 2025-12-18 - Simple to use Dialogue Library for Love2d with custom scripting language for dialogues .
...
* [Scenery](https://github.com/paltze/scenery) ⭐ 48 | 🐛 0 | 🌐 Lua | 📅 2025-01-13 - A dead simple scene/state management system.
...
* [Simple Love Lights](https://github.com/dylhunn/simple-love-lights) ⭐ 28 | 🐛 0 | 🌐 Lua | 📅 2020-03-24 - A very simple raycasting light implementation.
...
* [Cirno's Perfect Math Library](https://github.com/excessive/cpml) ⭐ 337 | 🐛 17 | 🌐 Lua | 📅 2026-02-11 - Math/intersection library designed for games.
...
* [Vornmath](https://github.com/DUznanski/vornmath) ⭐ 20 | 🐛 12 | 🌐 Lua | 📅 2026-03-06 - The most comprehensive small vector & matrix, complex number, and quaternion library for Lua.
...
* [Lua-Opus](https://github.com/GwyrddGlas/Lua-Opus) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2026-01-29 - A module for streaming and decoding Ogg Opus audio files with queueable playback and PCM integration.

## Networking

*Networking & Online-Play Libraries*

* [NoobHub](https://github.com/Overtorment/NoobHub) ⭐ 348 | 🐛 2 | 🌐 Lua | 📅 2024-07-16 - OpenSource multiplayer and network messaging. (IPv6)
...
* [fetch-lua](https://github.com/elloramir/fetch-lua) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2025-06-19 - An HTTPS/HTTP requests library made only with luajjit.

## OO

*Object Orientation Libraries that support [Class-Commons](https://github.com/bartbes/Class-Commons) ⭐ 56 | 🐛 2 | 📅 2018-01-13*

* [middleclass](https://github.com/kikito/middleclass) ⭐ 1,897 | 🐛 0 | 🌐 Lua | 📅 2025-11-03 - Simple OOP library for Lua; has inheritance, metamethods (operators), class variables and weak mixin support (class-commons).
* [classic](https://github.com/rxi/classic/) ⭐ 1,033 | 🐛 19 | 🌐 Lua | 📅 2021-12-31 - Tiny class module for Lua. Attempts to stay simple and provide decent performance by avoiding unnecessary over-abstraction.
* [knife.base](https://github.com/airstruck/knife/blob/master/readme/base.md) ⭐ 505 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Extremely minimal base class providing single inheritance and constructors.
...
* [Bump](https://github.com/kikito/bump.lua) ⭐ 1,075 | 🐛 13 | 🌐 Lua | 📅 2023-09-29 - Collision detection library for Lua.
...
* [slick](https://github.com/erinmaus/slick/) ⭐ 78 | 🐛 9 | 🌐 Lua | 📅 2026-02-11 - A simple to use polygon collision library inspired by bump.lua.
...
* [LÖVR](https://github.com/bjornbytes/lovr) ⭐ 2,499 | 🐛 16 | 🌐 C | 📅 2026-03-06 - LÖVE for virtual reality devices.
* [Love.js](https://github.com/Davidobot/love.js) ⭐ 809 | 🐛 68 | 🌐 JavaScript | 📅 2024-05-13 - LÖVE ported to the web using Emscripten.
* [LoveDos](https://github.com/rxi/lovedos) ⚠️ Archived - A Lua framework for 2D DOS games, implementing a subset of the LÖVE API.
* [LÖVE Potion](https://github.com/lovebrew/lovepotion) ⭐ 658 | 🐛 3 | 🌐 C++ | 📅 2026-02-12 - Unofficial implementation of the LÖVE for Nintendo (3DS, Switch and Wii U) Homebrew.
...
* [knife.serialize](https://github.com/airstruck/knife/blob/master/readme/serialize.md) ⭐ 505 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Serialize data as a Lua script.
...
* [Moonshine](https://github.com/vrld/moonshine) ⭐ 694 | 🐛 18 | 🌐 Lua | 📅 2023-12-23 - Repository of common post-processing effects like blur, vignette, color-grading, etc.
...
* [busted](https://github.com/lunarmodules/busted) ⭐ 1,596 | 🐛 63 | 🌐 Lua | 📅 2026-01-23 - Simple unit-testing framework with customizable assertions.
* [knife.test](https://github.com/airstruck/knife/blob/master/readme/test.md) ⭐ 505 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Fixture-free test framework.
* [Luassert](https://github.com/lunarmodules/luassert) ⭐ 242 | 🐛 9 | 🌐 Lua | 📅 2024-11-07 - Extends `assert()` with additional, customizable tests.
* [lust](https://github.com/bjornbytes/lust) ⭐ 126 | 🐛 0 | 🌐 Lua | 📅 2024-10-03 - Minimal test framework.
...
* [knife.timer](https://github.com/airstruck/knife/blob/master/readme/timer.md) ⭐ 505 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Create timers and tweens with ease.
* [Flux](https://github.com/rxi/flux) ⭐ 471 | 🐛 9 | 🌐 Lua | 📅 2020-12-16 - A fast, lightweight tweening library for Lua.
...
* [SUIT](https://github.com/vrld/SUIT) ⭐ 526 | 🐛 18 | 🌐 Lua | 📅 2023-08-26 - Small immediate mode GUI library.
* [Löve-Nuklear](https://github.com/keharriso/love-nuklear) ⭐ 383 | 🐛 6 | 🌐 C | 📅 2025-02-14 - Lightweight immediate mode GUI for LÖVE games.
* [Slab](https://github.com/flamendless/Slab) ⭐ 368 | 🐛 25 | 🌐 Lua | 📅 2026-02-10 - An immediate mode GUI toolkit for the LÖVE framework.
* [Love Imgui](https://github.com/slages/love-imgui) ⭐ 346 | 🐛 27 | 🌐 C++ | 📅 2023-12-03 - Imgui module for the LÖVE game engine.
...
* [Luis](https://github.com/SiENcE/luis) ⭐ 108 | 🐛 1 | 🌐 Lua | 📅 2026-03-01 - Love UI System - A retained mode UI framework for LÖVE with input processing (mouse, keyboard, touch, gamepad), layer-, grid-, state-, theming-system, UI editor, 16+ widgets (for desktop & mobile).
* [Inky](https://github.com/Keyslam/Inky) ⭐ 82 | 🐛 4 | 🌐 Lua | 📅 2025-12-20 - Any-purpose GUI framework.
* [lovr-ui2d](https://github.com/immortalx74/lovr-ui2d) ⭐ 73 | 🐛 0 | 🌐 Lua | 📅 2025-11-21 - An immediate mode GUI library for LÖVR and LÖVE.
...
* [Plan](https://github.com/zombrodo/plan) ⭐ 27 | 🐛 0 | 🌐 Lua | 📅 2026-03-02 - A super simple Rule-based layout library.
* [LOVELi](https://github.com/mtanksl/LOVELi) ⭐ 22 | 🐛 0 | 🌐 Lua | 📅 2025-10-01 - Retained mode layout and GUI library inspired by .NET's MAUI controls with StackLayout, AbsoluteLayout, Grid, Label, Button, Image, CheckBox, RadioButton, Switch, ProgressBar, Slider, TextBox and Border.
...
* [FlexLöve](https://github.com/mikefreno/FlexLove) ⭐ 16 | 🐛 0 | 🌐 Lua | 📅 2026-03-03 - A fully featured GUI library, supporting flexbox/grid/absolute layouts, both immediate and retained mode, 9patch theming and advanced event support.
...
* [log.lua](https://github.com/rxi/log.lua) ⭐ 355 | 🐛 5 | 🌐 Lua | 📅 2023-08-23 - Library for configurable log output.
* [luasteam](https://github.com/uspgamedev/luasteam) ⭐ 217 | 🐛 15 | 🌐 C++ | 📅 2026-03-04 - Lua bindings for the Steamworks API.
...
* [IntelliJ IDEA](https://www.jetbrains.com/idea/) - Capable and Ergonomic Java IDE.
  * [EmmyLua](https://github.com/EmmyLua/VSCode-EmmyLua) ⭐ 725 | 🐛 30 | 🌐 TypeScript | 📅 2026-02-02 - Lua IDE/Debugger Plugin for VSCode.
...
* [Zed](https://zed.dev) - A next-generation code editor designed for high-performance collaboration, written in Rust.
  * [love2d](https://github.com/LuaCATS/love2d) ⭐ 64 | 🐛 4 | 🌐 Lua | 📅 2024-12-03 - LuaCATS typing hints for the lua language server.
...
* [AppImageKit](https://github.com/AppImage/AppImageKit) ⭐ 9,273 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Using AppImageKit you can package LÖVE games as AppImages that run on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, Debian and derivatives; one game = one file.
...
* [makelove](https://github.com/pfirsich/makelove) ⭐ 193 | 🐛 24 | 🌐 Python | 📅 2024-06-08 - Advanced multi-platform tool to fuse your game written in Python 3. Supports Windows and Linux with AppImage.
* [LÖVE Game Development & Automated Build System](https://github.com/Oval-Tutu/bootstrap-love2d-project) ⭐ 167 | 🐛 11 | 🌐 Lua | 📅 2025-12-15 - Preconfigured VSCode/Codium. Build for Android, iOS, HTML5, Linux, macOS and Windows and automatically publish to Itch.io.
* [boon](https://github.com/camchenry/boon) ⭐ 156 | 🐛 5 | 🌐 Rust | 📅 2024-01-07 - Multi-platform, easy to use tool supporting Windows, macOS, Linux.
* [love-build](https://github.com/ellraiser/love-build) ⭐ 83 | 🐛 3 | 🌐 Lua | 📅 2025-05-30 - Downloadable application (made in LÖVE!) that can build games for Windows, macOS, and Linux regardless of your own OS.
...
* [awesome-lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,478 | 🐛 47 | 📅 2024-08-11 - A list like this one, but more general and encompassing all of Lua's uses.
* [awesome-pico8](https://github.com/pico-8/awesome-PICO-8) ⭐ 2,977 | 🐛 0 | 📅 2026-02-18 - A curated list of PICO-8 resources, tutorials, tools and more.
* [awesome-love-shaders](https://github.com/karai17/awesome-love-shaders) ⭐ 92 | 🐛 3 | 🌐 GLSL | 📅 2015-10-13 - A collection of shaders designed to work in LÖVE.

Other awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,277 | 🐛 45 | 🌐 Ruby | 📅 2024-06-02 list.
