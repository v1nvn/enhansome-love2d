# Awesome Löve [![Awesome](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 450,304 | 🐛 88 | 📅 2026-03-09 with stars
...
* [g3d](https://github.com/groverburger/g3d) ⭐ 778 | 🐛 2 | 🌐 Lua | 📅 2025-12-16 - Simple and easy 3D engine for LÖVE.
...
* [anim8](https://github.com/kikito/anim8) ⭐ 954 | 🐛 7 | 🌐 Lua | 📅 2022-01-20 - Animation library.
...
* [Concord](https://github.com/Keyslam-Group/Concord) ⭐ 308 | 🐛 10 | 🌐 Lua | 📅 2026-01-11 - A feature-complete ECS library.
...
* [evolved.lua](https://github.com/BlackMATov/evolved.lua) ⭐ 197 | 🐛 1 | 🌐 Lua | 📅 2026-03-30 - Evolved ECS (Entity-Component-System) for Lua.
...
* [Moonshine](https://github.com/vrld/moonshine) ⭐ 700 | 🐛 18 | 🌐 Lua | 📅 2023-12-23 - Repository of common post-processing effects like blur, vignette, color-grading, etc.
...
* [busted](https://github.com/lunarmodules/busted) ⭐ 1,603 | 🐛 64 | 🌐 Lua | 📅 2026-03-19 - Simple unit-testing framework with customizable assertions.
...
* [LOVELi](https://github.com/mtanksl/LOVELi) ⭐ 27 | 🐛 0 | 🌐 Lua | 📅 2025-10-01 - Retained mode layout and GUI library inspired by .NET's MAUI controls with StackLayout, AbsoluteLayout, Grid, Label, Button, Image, CheckBox, RadioButton, Switch, ProgressBar, Slider, TextBox and Border.
* [FlexLöve](https://github.com/mikefreno/FlexLove) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2026-03-30 - A fully featured GUI library, supporting flexbox/grid/absolute layouts, both immediate and retained mode, 9patch theming and advanced event support.
...
* [ProdUI](https://github.com/frank-f-trafton/prod_ui_wip) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2026-03-31 - A user interface library for the LÖVE Framework.
...
* [AppImageKit](https://github.com/AppImage/AppImageKit) ⭐ 9,296 | 🐛 235 | 🌐 C | 📅 2025-06-09 - Using AppImageKit you can package LÖVE games as AppImages that run on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, Debian and derivatives; one game = one file.
...
* [awesome-lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,488 | 🐛 47 | 📅 2024-08-11 - A list like this one, but more general and encompassing all of Lua's uses.
...
Other awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,313 | 🐛 50 | 🌐 Ruby | 📅 2024-06-02 list.
